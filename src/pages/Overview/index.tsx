...
const Overview: React.FC<OverviewProps> = (props) => {
  ...
  const texts = {
    es: {
      ...
      purposeList1: "Comparar la posición de las Islas Canarias con otras comunidades autónomas españolas y países europeos",
